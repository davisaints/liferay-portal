...
/**
 * Provides the remote service interface for PatcherFix. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see PatcherFixServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface PatcherFixService extends BaseService {
...
// LIFERAY-SERVICE-BUILDER-HASH:-1888083276